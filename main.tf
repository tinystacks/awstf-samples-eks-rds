...
module "hello_world_aws_db_security_group" {
  source = "git::https://github.com/tinystacks/tinystacks-terraform-modules.git//aws/modules/security_group"
...
module "hello_world_aws_rds_postgres" {
  source = "git::https://github.com/tinystacks/tinystacks-terraform-modules.git//aws/modules/rds"
...
module "hello_ts_aws_eks_cluster" {
  source = "git::https://github.com/tinystacks/tinystacks-terraform-modules.git//aws/modules/eks_cluster"
...
module "hello_ts_aws_eks_helm_kubewatch" {
  source = "git::https://github.com/tinystacks/tinystacks-terraform-modules.git//aws/modules/eks_helm"
